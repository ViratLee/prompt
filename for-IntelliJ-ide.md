...
**อยากให้ผมลองเขียน Scenario ของ Cucumber สักอันหนึ่งโดยใช้กฎที่คุณตั้งไว้ เพื่อเอาไปลอง Paste เช็คดูไหมครับว่า Copilot ทำตามกฎ Java 17 ได้ถูกต้องหรือเปล่า?**